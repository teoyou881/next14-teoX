'use client';
// If you need the URLs of the children as well, you can use useSelectedLayoutSegment.
// If you are at compose/tweet
// useSelectedLayoutSegments() returns { pathname: '/compose/tweet', query: {} }
// useSelectedLayoutSegment() returns '/compose
